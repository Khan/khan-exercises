(function() {
	...
	icu.getCountryName = function() { return "China" };
	...
	icu.getLanguage = function() { return "ug" };
	icu.getLanguageName = function() { return "Uighur" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Uighur (China)" };
