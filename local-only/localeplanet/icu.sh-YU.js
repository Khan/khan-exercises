(function() {
	...
	icu.getCountry = function() { return "YU" };
	...
	icu.getLanguage = function() { return "sh" };
	icu.getLanguageName = function() { return "Srpskohrvatski" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Srpskohrvatski (Srbija)" };
