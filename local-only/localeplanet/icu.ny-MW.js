(function() {
	...
	icu.getCountry = function() { return "MW" };
	icu.getCountryName = function() { return "Malawi" };
	...
	icu.getLanguage = function() { return "ny" };
	icu.getLanguageName = function() { return "Nyanja" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Nyanja (Malawi)" };
