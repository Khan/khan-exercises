(function() {
	...
	icu.getCountry = function() { return "TJ" };
	icu.getCountryName = function() { return "Tajikistan" };
	...
	icu.getLanguage = function() { return "tg" };
	icu.getLanguageName = function() { return "Tajik" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Tajik (Cyrillic, Tajikistan)" };
