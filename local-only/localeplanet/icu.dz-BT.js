(function() {
	...
	icu.getCountry = function() { return "BT" };
	icu.getCountryName = function() { return "Bhutan" };
	...
	icu.getLanguage = function() { return "dz" };
	icu.getLanguageName = function() { return "Dzongkha" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Dzongkha (Bhutan)" };
