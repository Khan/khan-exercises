(function() {
	...
	icu.getCountryName = function() { return "Liberia" };
	...
	icu.getLanguage = function() { return "kpe" };
	icu.getLanguageName = function() { return "Kpelle" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Kpelle (Liberia)" };
