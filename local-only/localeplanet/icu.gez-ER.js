(function() {
	...
	icu.getCountryName = function() { return "Eritrea" };
	...
	icu.getLanguage = function() { return "gez" };
	icu.getLanguageName = function() { return "Geez" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Geez (Eritrea)" };
