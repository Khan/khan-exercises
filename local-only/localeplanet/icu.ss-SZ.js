(function() {
	...
	icu.getCountry = function() { return "SZ" };
	icu.getCountryName = function() { return "Swaziland" };
	...
	icu.getLanguage = function() { return "ss" };
	icu.getLanguageName = function() { return "Swati" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Swati (Swaziland)" };
