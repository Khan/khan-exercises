(function() {
	...
	icu.getCountryName = function() { return "Syria" };
	...
	icu.getLanguage = function() { return "ku" };
	icu.getLanguageName = function() { return "Kurdish" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Kurdish (Arabic, Syria)" };
