(function() {
	...
	icu.getCountryName = function() { return "Taiwan" };
	...
	icu.getLanguage = function() { return "trv" };
	icu.getLanguageName = function() { return "Taroko" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Taroko (Taiwan)" };
