(function() {
	...
	icu.getCountry = function() { return "KG" };
	icu.getCountryName = function() { return "Kyrgyzstan" };
	...
	icu.getLanguage = function() { return "ky" };
	icu.getLanguageName = function() { return "Kirghiz" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Kirghiz (Kyrgyzstan)" };
