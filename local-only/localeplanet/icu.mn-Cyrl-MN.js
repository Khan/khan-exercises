(function() {
	...
	icu.getCountry = function() { return "MN" };
	icu.getCountryName = function() { return "Mongolia" };
	...
	icu.getLanguageName = function() { return "Mongolian" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Mongolian (Cyrillic, Mongolia)" };
