(function() {
	...
	icu.getCountry = function() { return "MV" };
	icu.getCountryName = function() { return "Maldives" };
	...
	icu.getLanguage = function() { return "dv" };
	icu.getLanguageName = function() { return "Divehi" };
