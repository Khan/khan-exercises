(function() {
	...
	icu.getCountryName = function() { return "Germany" };
	...
	icu.getLanguage = function() { return "nds" };
	icu.getLanguageName = function() { return "Low German" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Low German (Germany)" };
