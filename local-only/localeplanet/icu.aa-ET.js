(function() {
	...
	icu.getCountryName = function() { return "Ethiopia" };
	...
	icu.getLanguage = function() { return "aa" };
	icu.getLanguageName = function() { return "Afar" };
	icu.getLocale = function() { return "null" };
	icu.getLocaleName = function() { return "Afar (Ethiopia)" };
