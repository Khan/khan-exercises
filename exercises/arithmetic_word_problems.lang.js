({
	"nl" : {
		"vraag1" : "<var>person(1)</var> is putting <var>plural( item(1) )</var> into <var>plural( group(1) )</var>.
		...
		"vraag2"  : "<var>person(1)</var> kocht <var>plural( ITEM_1_COUNT, storeItem(1, 1) )</var>,
		...
		"vraag3"  : "<var>person(1)</var> has a bunch of <var>plural( item(1) )</var>. When <var>person(1)</var> places <var>plural( ITEMS, item(1) )</var> in each
