({
	"nl" : {
		...
		"hint10"	: '<code>\\text{gedeelte van de <var>pizza( 1 )</var> blijf over} = \\dfrac{\text{aantal stukken blijft over}}{\\text{number slices total}}</code>',
		...
		"hint21"	: '<strong><var>person( 1 )</var> had nog <var>SOLUTION</var> liter benzine in <var>his( 1 )</var> tank toen <var>he( 1 )</var> checked.</strong>',
		"hint22"	: 'We kunnen vermenigvuldigen <code><var>ATTENDEES</var></code> met <code>\\dfrac{<var>N</var>}{<var>D</var>}</code> om te achterhalen hoeveel volwassenen er op de picknick waren.',
