(function() {
    ...
    asyncTest("number big integer", 18, function() {
        ...
        testAnswer(answerData, "123 45 678", "empty-message", "right answer with wrong commas is wrong");
    ...
    asyncTest("number pi (rational > 1)", 21, function() {
        ...
        testAnswer(answerData, "4 5pi/6", "empty-message", "wrong answer is wrong");
    ...
    asyncTest("number leading zeros are not okay on integers", 12, function() {
        ...
        testAnswer(answerData, "0.000.372", "empty-message", "many leading zeros are empty-message");
